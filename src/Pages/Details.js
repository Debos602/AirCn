                ...
                <div className="flex-1 max-w-lg">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col items-start pb-4 mx-auto my-2 max-w-7xl sm:flex-row">
                            ...
                            <div className="flex-grow prose sm:text-left prose-md">
                                <p className="text-gray-500 text-xl">
                                    Atik is a Super host
                                </p>
                                <p className="text-gray-400">
                                    Super hosts are experienced, highly rated
                    ...
                    <div className="mt-4 text-gray-500">
                        <p>
                            It's newly constructed 7 storied building
                            maintaining building code by a locally famous
                            architect. Enough lights and natural air are playing
                            here. The place (apartment) is calm and noise free.
                            You'll love my place for its lovely and bright looks
                            comfortable stay.
                        </p>
                        <p>
                            Bangladesh is a beauty with its six seasons and
                            green. The people are hospitable and worm.It's newly
                            constructed 7 storied building maintaining building
                            code by a locally famous architect. Enough lights
                            and natural air are playing here. The place
                            (apartment) is calm and noise free. You'll love my
                            place for its lovely and bright looks comfortable
                            Stay.
                        </p>
                        <p>
                            Bangladesh is a beauty with its six seasons and
                            green. The people are hospitable and worm.
                        </p>
                    </div>
                    <br />
